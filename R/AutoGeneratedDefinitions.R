...
#' details, hash object, etc. from WebApi for ConceptSet. This function is useful 
#' to retrieve the current ConceptSet specifications.  
#'  
#' @template BaseUrl                        
#' @return
#' A tibble of specification metadata for ConceptSet. Note: modifiedDate and createdDate are
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a ConceptSet is valid. The following checks are 
...
#'                       ConceptSet definition in a WebApi instance.
#' @return
...
#' \lifecycle{stable}
#' @details
#' Detect string matched ConceptSet definition names from the WebApi, and retrieve
...
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getConceptSetDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#' @param conceptSetDefinition    An R list object containing the expression for the specification. 
...
#' }
#' @export
postConceptSetDefinition <- function(name, conceptSetDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'conceptSet', definition = conceptSetDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
#' @details
#' Get the meta data of WebApi specifications such as id, name, created/modified 
#' details, hash object, etc. from WebApi for Cohort. This function is useful 
#' to retrieve the current Cohort specifications.  
#'  
#' @template BaseUrl                        
#' @return
#' A tibble of specification metadata for Cohort. Note: modifiedDate and createdDate are
#' returned as text/character.
#' 
#' @examples 
#' \dontrun{
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a Cohort is valid. The following checks are 
#' performed. 1) checks if all the ids exists in the WebApi i.e. valid. 
#'  
#' @template BaseUrl
...
#'  
#' @template BaseUrl
#' @param cohortId   An integer id representing the id that uniquely identifies a 
#'                       Cohort definition in a WebApi instance.
#' @return
...
#' \lifecycle{stable}
#' @details
#' Detect string matched Cohort definition names from the WebApi, and retrieve
#' metadata definitions.
#'  
#' @template BaseUrl
#' @param pattern   A pattern to look for. See \link[stringr]{str_detect} for details.
#' @param negate    If TRUE, return non-matching elements. See \link[stringr]{str_detect} for details.
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getCohortDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#'                       the name of the definition. WebApi checks for validity,
#'                       such as uniqueness, absence of unacceptable character etc. An error might be thrown.
#' @param cohortDefinition    An R list object containing the expression for the specification. 
#'                                          This will be converted to JSON expression by function and posted into the WebApi.
#'                                          Note: only limited checks are performed in R to check the validity of this
#'                                          expression.
#' @param name           How to handle importing a definition with a name that already exists in ATLAS.
...
postCohortDefinition <- function(name, cohortDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'cohort', definition = cohortDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
#' @details
#' Get the meta data of WebApi specifications such as id, name, created/modified 
#' details, hash object, etc. from WebApi for IncidenceRate. This function is useful 
#' to retrieve the current IncidenceRate specifications.  
#'  
#' @template BaseUrl                        
#' @return
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a IncidenceRate is valid. The following checks are 
#' performed. 1) checks if all the ids exists in the WebApi i.e. valid. 
#'  
#' @template BaseUrl
...
#' @examples 
#' \dontrun{
#' isValidIncidenceRateId(incidenceRateIds = c(13242, 3423, 34), baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
...
#'  
#' @template BaseUrl
#' @param incidenceRateId   An integer id representing the id that uniquely identifies a 
#'                       IncidenceRate definition in a WebApi instance.
#' @return
...
#' \lifecycle{stable}
#' @details
#' Detect string matched IncidenceRate definition names from the WebApi, and retrieve
#' metadata definitions.
#'  
#' @template BaseUrl
#' @param pattern   A pattern to look for. See \link[stringr]{str_detect} for details.
#' @param negate    If TRUE, return non-matching elements. See \link[stringr]{str_detect} for details.
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getIncidenceRateDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#' }
#' @export
postIncidenceRateDefinition <- function(name, incidenceRateDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'incidenceRate', definition = incidenceRateDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
getIncidenceRateGenerationInformation <- function(incidenceRateId, baseUrl){
  .checkBaseUrl(baseUrl)
  response <- getGenerationInformation(id = incidenceRateId, baseUrl = baseUrl, category = 'incidenceRate')
 return(response)
}
...
#' @examples 
#' \dontrun{
#' getIncidenceRateResults(incidenceRateId = 342, 
#' baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
# Check name
...
#' @details
#' Get the meta data of WebApi specifications such as id, name, created/modified 
#' details, hash object, etc. from WebApi for Estimation. This function is useful 
#' to retrieve the current Estimation specifications.  
#'  
#' @template BaseUrl                        
#' @return
#' A tibble of specification metadata for Estimation. Note: modifiedDate and createdDate are
#' returned as text/character.
#' 
#' @examples 
#' \dontrun{
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a Estimation is valid. The following checks are 
#' performed. 1) checks if all the ids exists in the WebApi i.e. valid. 
#'  
#' @template BaseUrl
...
#'  
#' @template BaseUrl
#' @param estimationId   An integer id representing the id that uniquely identifies a 
#'                       Estimation definition in a WebApi instance.
#' @return
...
#' \lifecycle{stable}
#' @details
#' Detect string matched Estimation definition names from the WebApi, and retrieve
#' metadata definitions.
#'  
#' @template BaseUrl
#' @param pattern   A pattern to look for. See \link[stringr]{str_detect} for details.
#' @param negate    If TRUE, return non-matching elements. See \link[stringr]{str_detect} for details.
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getEstimationDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#'                       the name of the definition. WebApi checks for validity,
#'                       such as uniqueness, absence of unacceptable character etc. An error might be thrown.
#' @param estimationDefinition    An R list object containing the expression for the specification. 
#'                                          This will be converted to JSON expression by function and posted into the WebApi.
#'                                          Note: only limited checks are performed in R to check the validity of this
#'                                          expression.
#' @param name           How to handle importing a definition with a name that already exists in ATLAS.
...
#' }
#' @export
postEstimationDefinition <- function(name, estimationDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'estimation', definition = estimationDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
#' @details
#' Get the meta data of WebApi specifications such as id, name, created/modified 
#' details, hash object, etc. from WebApi for Prediction. This function is useful 
#' to retrieve the current Prediction specifications.  
#'  
#' @template BaseUrl                        
#' @return
#' A tibble of specification metadata for Prediction. Note: modifiedDate and createdDate are
#' returned as text/character.
#' 
#' @examples 
#' \dontrun{
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a Prediction is valid. The following checks are 
#' performed. 1) checks if all the ids exists in the WebApi i.e. valid. 
#'  
#' @template BaseUrl
...
#'  
#' @template BaseUrl
#' @param predictionId   An integer id representing the id that uniquely identifies a 
#'                       Prediction definition in a WebApi instance.
#' @return
...
#' \lifecycle{stable}
#' @details
#' Detect string matched Prediction definition names from the WebApi, and retrieve
#' metadata definitions.
#'  
#' @template BaseUrl
#' @param pattern   A pattern to look for. See \link[stringr]{str_detect} for details.
#' @param negate    If TRUE, return non-matching elements. See \link[stringr]{str_detect} for details.
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getPredictionDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#'                       the name of the definition. WebApi checks for validity,
#'                       such as uniqueness, absence of unacceptable character etc. An error might be thrown.
#' @param predictionDefinition    An R list object containing the expression for the specification. 
#'                                          This will be converted to JSON expression by function and posted into the WebApi.
#'                                          Note: only limited checks are performed in R to check the validity of this
#'                                          expression.
#' @param name           How to handle importing a definition with a name that already exists in ATLAS.
...
#' }
#' @export
postPredictionDefinition <- function(name, predictionDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'prediction', definition = predictionDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
#' @details
#' Get the meta data of WebApi specifications such as id, name, created/modified 
#' details, hash object, etc. from WebApi for Characterization. This function is useful 
#' to retrieve the current Characterization specifications.  
#'  
#' @template BaseUrl                        
#' @return
...
#' \lifecycle{stable}
#' @details
#' Checks if a set of id for a Characterization is valid. The following checks are 
#' performed. 1) checks if all the ids exists in the WebApi i.e. valid. 
#'  
#' @template BaseUrl
#' @param characterizationIds        A list of integer id(s) of the Characterization to be tested for validity.
#' @return                     A logical vector indicating if an ID is valid.
#' 
#' @examples 
#' \dontrun{
#' isValidCharacterizationId(characterizationIds = c(13242, 3423, 34), baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
...
#' @examples 
#' \dontrun{
#' getCharacterizationDefinition(characterizationId = 13242, baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
...
#' @examples 
#' \dontrun{
#' deleteCharacterizationDefinition(characterizationId = 13242, baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
deleteCharacterizationDefinition <- function(characterizationId, baseUrl){
  result <- deleteDefinition(baseUrl = baseUrl, id = characterizationId, category = 'characterization')
  return(result)
}
...
#' \lifecycle{stable}
#' @details
#' Detect string matched Characterization definition names from the WebApi, and retrieve
#' metadata definitions.
#'  
#' @template BaseUrl
#' @param pattern   A pattern to look for. See \link[stringr]{str_detect} for details.
#' @param negate    If TRUE, return non-matching elements. See \link[stringr]{str_detect} for details.
#' @return          FALSE if no matches. If matched - output from \link[ROhdsiWebApi]{getCharacterizationDefinitionsMetaData}
#' 
#' @examples 
#' \dontrun{
...
#'                       the name of the definition. WebApi checks for validity,
#'                       such as uniqueness, absence of unacceptable character etc. An error might be thrown.
#' @param characterizationDefinition    An R list object containing the expression for the specification. 
#'                                          This will be converted to JSON expression by function and posted into the WebApi.
#'                                          Note: only limited checks are performed in R to check the validity of this
#'                                          expression.
#' @param name           How to handle importing a definition with a name that already exists in ATLAS.
...
#' }
#' @export
postCharacterizationDefinition <- function(name, characterizationDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'characterization', definition = characterizationDefinition, duplicateNames = duplicateNames)
  return(result)
}
...
getCharacterizationGenerationInformation <- function(characterizationId, baseUrl){
  .checkBaseUrl(baseUrl)
  response <- getGenerationInformation(id = characterizationId, baseUrl = baseUrl, category = 'characterization')
 return(response)
}
...
#' @examples 
#' \dontrun{
#' getCharacterizationResults(characterizationId = 342, 
#' baseUrl = "http://server.org:80/WebAPI")
#' }
#' @export
# Check name
...
postPathwayDefinition <- function(name, pathwayDefinition, baseUrl, duplicateNames = 'error'){
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'pathway', definition = pathwayDefinition, duplicateNames = duplicateNames)
  return(result)
}
